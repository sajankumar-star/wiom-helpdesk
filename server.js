...
app.listen(PORT, async () => {
 ...
 const KEY_TO_PROBLEM = {
   ...
   camera_issue: 'laptop ki built-in webcam Teams ya Zoom call mein detect nahi ho rhi ya video nahi aa rha — camera hardware issue nahi, software/driver ya app setting issue hai', mic_issue: 'laptop ka microphone Teams ya Zoom mein kaam nahi kar rha, doosre logo ko awaaz nahi aa rhi',
  ...
  internet_slow: 'internet bahut slow hai',
   ...
   edge_issue: 'Microsoft Edge browser nahi khul rha ya crash ho rha — Task Manager se close karo dobara open karo', browser_slow: 'Google Chrome ya Edge browser bahut slow hai pages load hote hain ya freeze ho jaata hai',
   website_blocked: 'specific website load nahi ho rhi page nahi khul rha — network DNS issue ho sakta hai, IT policy se block nahi hai', teams_issue: 'Microsoft Teams nahi khul rha ya call drop ho rhi hai ya messages nahi aa rhe — system tray se Quit karo dobara open karo',
   zoom_issue: 'Zoom app nahi khul rha ya meeting join nahi ho rha — Zoom close karo dobara open karo, browser mein zoom.us try karo', pdf_issue: 'PDF file nahi khul rhi Adobe Acrobat ya Reader kaam nahi kar rha ya PDF open karne mein error',
  ...
  slack_issue: 'Slack app nahi khul rha ya slow hai ya messages nahi aa rhe — Quit karo system tray se, dobara open karo, agar bhi nahi to cache clear karo',
