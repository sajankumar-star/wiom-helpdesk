...
app.listen(PORT, async () => {
 ...
 const KEY_TO_PROBLEM = {
  ...
  internet_slow: 'internet bahut slow hai',
   ...
   website_blocked: 'specific website load nahi ho rhi page nahi khul rha — network DNS issue ho sakta hai, IT policy se block nahi hai', teams_issue: 'Teams app nahi khul rha ya call drop ho rhi hai ya messages nahi aa rhe — system tray se Quit karo dobara open karo',
