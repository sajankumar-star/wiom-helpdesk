...
app.listen(PORT, async () => {
 ...
 const KEY_TO_PROBLEM = {
  ...
  internet_slow: 'internet bahut slow hai',
   ...
   zoom_issue: 'Zoom app nahi khul rha ya meeting join nahi ho rhi ya audio-video issue hai — Zoom close karo dobara open karo, browser fallback use karo', pdf_issue: 'PDF file nahi khul rhi Adobe Acrobat ya Reader kaam nahi kar rha ya PDF open karne mein error',
